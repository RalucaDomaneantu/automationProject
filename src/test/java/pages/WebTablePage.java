...
public class WebTablePage extends BasePage{
    ...
    WebTableModel testData = new WebTableModel("src/test/resources/inputData/WebTableResouce.json");
    ...
    public void createProcess(WebTableModel testData){
        ...
        elementsMethod.fillElement(userEmailElement, testData.getUserEmail());
    ...
    public void editProcess(){
        ...
        elementsMethod.fillElement(editAgeElement, testData.getEditAgeElement());
